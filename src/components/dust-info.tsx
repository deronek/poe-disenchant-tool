  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 grid-rows-3 items-start justify-items-start gap-x-6 gap-y-2 md:grid-cols-[auto_auto_auto] md:grid-rows-2 md:gap-x-0 md:gap-y-2">
          ...
          <div className="col-start-2 row-start-1 md:col-start-1 md:row-start-2">
            <Badge variant="outline">Jewellery</Badge>
          </div>

          <div className="col-start-2 row-start-2 md:col-start-2 md:row-start-2">
